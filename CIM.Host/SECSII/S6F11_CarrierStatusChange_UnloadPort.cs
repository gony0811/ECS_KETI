...
{
    public class S6F11_CarrierStatusChange_UnloadPort : SFMessage
    {
        /*S6F11(Carrier Status Change), CEID:250, 251, 252, 253*/
        // 사양이 정확히 정해지면 Loader/Unloader로 나누어서 메세지 작성해야 함.
        public S6F11_CarrierStatusChange_UnloadPort(SECSDriver driver)
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCEID = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_CarrierLoadReqEventType", out bResult).ToString();
            ...
            string sPARENT_LOT = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_CarrierUnLoadReqParentLot", out bResult);
            string sRFID = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_CarrierUnLoadReqRFID", out bResult);
            string sPORTNO_1 = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_CarrierUnLoadReqPortNo", out bResult);
