...
{
    class S6F11_Unit_MaterialAssembleProcess2_1 : SFMessage
    {
         /*S6F11(Material Process Change), CEID: 911, 912, 913, 914, 915, 916, 917, 918, 919, 920, 921, 922, 923, 924, 925 */
        // CEID : 915
        public S6F11_Unit_MaterialAssembleProcess2_1(SECSDriver driver)
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCELLID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_CellID", out bResult);
            string sPPID = RMSManager.Instance.GetCurrentPPID();
            string sPRODUCTID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_ProductID", out bResult);
            string sSTEPID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_StepID", out bResult);
            ...
            #region Define
            Unit1_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_BatchID", out bResult);
            Unit1_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_BatchName", out bResult);
            Unit1_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_ID", out bResult);
            Unit1_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_Type", out bResult);
            Unit1_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_ST", out bResult);
            Unit1_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_PortID", out bResult);
            Unit1_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Assem2_1_State", out bResult);
            Unit1_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit1_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit1_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit1_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit1_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit1_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit1_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit1_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit1_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit1_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit2_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_BatchID", out bResult);
            Unit2_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_BatchName", out bResult);
            Unit2_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_ID", out bResult);
            Unit2_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_Type", out bResult);
            Unit2_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_ST", out bResult);
            Unit2_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_PortID", out bResult);
            Unit2_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Assem2_1_State", out bResult);
            Unit2_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit2_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit2_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit2_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit2_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit2_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit2_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit2_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit2_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit2_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit3_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_BatchID", out bResult);
            Unit3_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_BatchName", out bResult);
            Unit3_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_ID", out bResult);
            Unit3_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_Type", out bResult);
            Unit3_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_ST", out bResult);
            Unit3_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_PortID", out bResult);
            Unit3_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Assem2_1_State", out bResult);
            Unit3_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit3_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit3_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit3_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit3_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit3_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit3_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit3_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit3_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit3_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit4_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_BatchID", out bResult);
            Unit4_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_BatchName", out bResult);
            Unit4_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_ID", out bResult);
            Unit4_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_Type", out bResult);
            Unit4_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_ST", out bResult);
            Unit4_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_PortID", out bResult);
            Unit4_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Assem2_1_State", out bResult);
            Unit4_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit4_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit4_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit4_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit4_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit4_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit4_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit4_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit4_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit4_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit5_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_BatchID", out bResult);
            Unit5_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_BatchName", out bResult);
            Unit5_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_ID", out bResult);
            Unit5_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_Type", out bResult);
            Unit5_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_ST", out bResult);
            Unit5_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_PortID", out bResult);
            Unit5_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Assem2_1_State", out bResult);
            Unit5_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit5_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit5_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit5_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit5_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit5_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit5_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit5_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit5_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit5_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit6_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_BatchID", out bResult);
            Unit6_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_BatchName", out bResult);
            Unit6_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_ID", out bResult);
            Unit6_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_Type", out bResult);
            Unit6_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_ST", out bResult);
            Unit6_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_PortID", out bResult);
            Unit6_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Assem2_1_State", out bResult);
            Unit6_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit6_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit6_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit6_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit6_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit6_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit6_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit6_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit6_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit6_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit7_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_BatchID", out bResult);
            Unit7_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_BatchName", out bResult);
            Unit7_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_ID", out bResult);
            Unit7_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_Type", out bResult);
            Unit7_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_ST", out bResult);
            Unit7_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_PortID", out bResult);
            Unit7_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Assem2_1_State", out bResult);
            Unit7_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit7_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit7_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit7_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit7_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit7_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit7_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit7_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit7_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit7_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();

            Unit8_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_BatchID", out bResult);
            Unit8_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_BatchName", out bResult);
            Unit8_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_ID", out bResult);
            Unit8_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_Type", out bResult);
            Unit8_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_ST", out bResult);
            Unit8_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_PortID", out bResult);
            Unit8_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Assem2_1_State", out bResult);
            Unit8_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_TotalQty", out bResult).ToString();
            Unit8_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_UseQty", out bResult).ToString();
            Unit8_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_AssemQty", out bResult).ToString();
            Unit8_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_NGQty", out bResult).ToString();
            Unit8_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_RemainQty", out bResult).ToString();
            Unit8_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_ProductQty", out bResult).ToString();
            Unit8_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_ProcessUseQty", out bResult).ToString();
            Unit8_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_ProcessAssemQty", out bResult).ToString();
            Unit8_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_ProcessNGQty", out bResult).ToString();
            Unit8_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Assem2_1_SupplyReqQty", out bResult).ToString();
            #endregion
