...
{
    public class S6F11_Unit_MaterialProcessChange1 : SFMessage
    {
        ...
        public S6F11_Unit_MaterialProcessChange1(SECSDriver driver)
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCEID = ((int)DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_CEID", out bResult)).ToString();
            ...
            if (sUNITID == aUNITID[0])
            {
                ...
                {
                    Unit1_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_BatchID", out bResult);
                    Unit1_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_BatchName", out bResult);

                    Unit1_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_ID", out bResult);
                    Unit1_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_Type", out bResult);
                    Unit1_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_ST", out bResult);
                    Unit1_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_PortID", out bResult); ;
                    Unit1_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit1_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_PortID", out bResult); ;
                    Unit1_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_Kitting1_State", out bResult);
                    Unit1_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit1_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit1_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit1_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit1_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit1_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit1_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit1_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit1_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit1_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[1])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit2_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_BatchID", out bResult);
                    Unit2_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_BatchName", out bResult);

                    Unit2_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_ID", out bResult);
                    Unit2_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_Type", out bResult);
                    Unit2_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_ST", out bResult);
                    Unit2_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_PortID", out bResult); ;
                    Unit2_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit2_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_PortID", out bResult); ;
                    Unit2_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_Kitting1_State", out bResult);
                    Unit2_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit2_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit2_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit2_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit2_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit2_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit2_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit2_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit2_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit2_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[2])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit3_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_BatchID", out bResult);
                    Unit3_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_BatchName", out bResult);

                    Unit3_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_ID", out bResult);
                    Unit3_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_Type", out bResult);
                    Unit3_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_ST", out bResult);
                    Unit3_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_PortID", out bResult); ;
                    Unit3_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit3_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_PortID", out bResult); ;
                    Unit3_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_Kitting1_State", out bResult);
                    Unit3_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit3_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit3_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit3_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit3_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit3_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit3_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit3_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit3_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit3_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC3_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[3])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit4_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_BatchID", out bResult);
                    Unit4_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_BatchName", out bResult);

                    Unit4_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_ID", out bResult);
                    Unit4_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_Type", out bResult);
                    Unit4_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_ST", out bResult);
                    Unit4_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_PortID", out bResult); ;
                    Unit4_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit4_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_PortID", out bResult); ;
                    Unit4_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_Kitting1_State", out bResult);
                    Unit4_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit4_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit4_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit4_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit4_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit4_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit4_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit4_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit4_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit4_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC4_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[4])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit5_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_BatchID", out bResult);
                    Unit5_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_BatchName", out bResult);

                    Unit5_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_ID", out bResult);
                    Unit5_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_Type", out bResult);
                    Unit5_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_ST", out bResult);
                    Unit5_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_PortID", out bResult); ;
                    Unit5_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit5_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_PortID", out bResult); ;
                    Unit5_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_Kitting1_State", out bResult);
                    Unit5_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit5_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit5_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit5_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit5_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit5_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit5_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit5_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit5_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit5_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC5_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[5])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit6_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_BatchID", out bResult);
                    Unit6_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_BatchName", out bResult);

                    Unit6_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_ID", out bResult);
                    Unit6_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_Type", out bResult);
                    Unit6_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_ST", out bResult);
                    Unit6_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_PortID", out bResult); ;
                    Unit6_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit6_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_PortID", out bResult); ;
                    Unit6_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_Kitting1_State", out bResult);
                    Unit6_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit6_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit6_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit6_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit6_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit6_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit6_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit6_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit6_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit6_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC6_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[6])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit7_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_BatchID", out bResult);
                    Unit7_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_BatchName", out bResult);

                    Unit7_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_ID", out bResult);
                    Unit7_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_Type", out bResult);
                    Unit7_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_ST", out bResult);
                    Unit7_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_PortID", out bResult); ;
                    Unit7_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit7_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_PortID", out bResult); ;
                    Unit7_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_Kitting1_State", out bResult);
                    Unit7_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit7_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit7_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit7_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit7_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit7_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit7_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit7_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit7_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit7_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
            ...
            else if (sUNITID == aUNITID[7])
            {
                if (sCEID == "221" || sCEID == "211" || sCEID == "220" || sCEID == "224") // Kitting, material Supplement, complete, Shortage
                {
                    Unit8_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_BatchID", out bResult);
                    Unit8_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_BatchName", out bResult);

                    Unit8_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_ID", out bResult);
                    Unit8_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_Type", out bResult);
                    Unit8_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_ST", out bResult);
                    Unit8_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_PortID", out bResult); ;
                    Unit8_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_State", out bResult);
                ...
                else if (sCEID == "219" || sCEID == "225" || sCEID == "223") // Kitting Cancel, Location Update, Warning
                {
                    ...
                    Unit8_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_PortID", out bResult); ;
                    Unit8_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_Kitting1_State", out bResult);
                    Unit8_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_TotalQty", out bResult).ToString();
                    Unit8_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_UseQty", out bResult).ToString();
                    Unit8_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_AssemQty", out bResult).ToString();
                    Unit8_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_NGQty", out bResult).ToString();
                    Unit8_MAT_MAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_RemainQty", out bResult).ToString();
                    Unit8_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_ProductQty", out bResult).ToString();
                    Unit8_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_ProcessUseQty", out bResult).ToString();
                    Unit8_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_ProcessAssemQty", out bResult).ToString();
                    Unit8_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_ProcessNGQty", out bResult).ToString();
                    Unit8_MAT_SUPPLY_QUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC8_EtoC_Kitting1_SupplyReqQty", out bResult).ToString();
                }
