...
{
    public class S6F11_Unit_InterlockConfirm : SFMessage
    {
        /*S6F11(TRS Interlock Confirm), CEID:512*/
        public S6F11_Unit_InterlockConfirm(SECSDriver driver) 
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            short Unit1_nINTERLOCK_NO = 1;
            short Unit2_nINTERLOCK_NO = 1;
            short Unit3_nINTERLOCK_NO = 1;
            short Unit4_nINTERLOCK_NO = 1;
            short Unit5_nINTERLOCK_NO = 1;
            short Unit6_nINTERLOCK_NO = 1;
            short Unit7_nINTERLOCK_NO = 1;
            short Unit8_nINTERLOCK_NO = 1;
            ...
            if (aUNITID[0] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        msg.AddList(2);                                                                                     //L2  RPTID 701 Set
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit1_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit1_aINTERLOCK_ID = new string[Unit1_nINTERLOCK_NO];
                                string[] Unit1_aMESSAGE = new string[Unit1_nINTERLOCK_NO];

                                for (int i = 0; i < Unit1_nINTERLOCK_NO; i++)
                                {
                                    Unit1_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_InterlockIDComfirm", out bResult);
                                    Unit1_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit1_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit1_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[1] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit2_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit2_aINTERLOCK_ID = new string[Unit2_nINTERLOCK_NO];
                                string[] Unit2_aMESSAGE = new string[Unit2_nINTERLOCK_NO];

                                for (int i = 0; i < Unit2_nINTERLOCK_NO; i++)
                                {
                                    Unit2_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_InterlockIDComfirm", out bResult);
                                    Unit2_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit2_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit2_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[2] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit3_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit3_aINTERLOCK_ID = new string[Unit3_nINTERLOCK_NO];
                                string[] Unit3_aMESSAGE = new string[Unit3_nINTERLOCK_NO];

                                for (int i = 0; i < Unit3_nINTERLOCK_NO; i++)
                                {
                                    Unit3_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_InterlockIDComfirm", out bResult);
                                    Unit3_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC3_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit3_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit3_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[3] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit4_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit4_aINTERLOCK_ID = new string[Unit4_nINTERLOCK_NO];
                                string[] Unit4_aMESSAGE = new string[Unit4_nINTERLOCK_NO];

                                for (int i = 0; i < Unit4_nINTERLOCK_NO; i++)
                                {
                                    Unit4_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_InterlockIDComfirm", out bResult);
                                    Unit4_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC4_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit4_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit4_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[4] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit5_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit5_aINTERLOCK_ID = new string[Unit5_nINTERLOCK_NO];
                                string[] Unit5_aMESSAGE = new string[Unit5_nINTERLOCK_NO];

                                for (int i = 0; i < Unit5_nINTERLOCK_NO; i++)
                                {
                                    Unit5_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_InterlockIDComfirm", out bResult);
                                    Unit5_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC5_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit5_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit5_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[5] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit6_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit6_aINTERLOCK_ID = new string[Unit6_nINTERLOCK_NO];
                                string[] Unit6_aMESSAGE = new string[Unit6_nINTERLOCK_NO];

                                for (int i = 0; i < Unit6_nINTERLOCK_NO; i++)
                                {
                                    Unit6_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_InterlockIDComfirm", out bResult);
                                    Unit6_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC6_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit6_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit6_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[6] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit7_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit7_aINTERLOCK_ID = new string[Unit7_nINTERLOCK_NO];
                                string[] Unit7_aMESSAGE = new string[Unit7_nINTERLOCK_NO];

                                for (int i = 0; i < Unit7_nINTERLOCK_NO; i++)
                                {
                                    Unit7_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_InterlockIDComfirm", out bResult);
                                    Unit7_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit7_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit7_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
            ...
            else if (aUNITID[7] == sUNITID)
            {
                ...
                msg.AddList(3);                                                                                     //L3  Interlock Event Info
                {
                    ...
                    msg.AddList(4);                                                                                     //L4  RPTID Set
                    {
                        ...
                        {
                            msg.AddAscii(AppUtil.ToAscii("701", gDefine.DEF_RPTID_SIZE));                                       //A3  RPTID="701"
                            msg.AddList(Unit8_nINTERLOCK_NO);                                                                         //Ln  Interlock
                            {
                                string[] Unit8_aINTERLOCK_ID = new string[Unit8_nINTERLOCK_NO];
                                string[] Unit8_aMESSAGE = new string[Unit8_nINTERLOCK_NO];

                                for (int i = 0; i < Unit8_nINTERLOCK_NO; i++)
                                {
                                    Unit8_aINTERLOCK_ID[i] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_InterlockIDComfirm", out bResult);
                                    Unit8_aMESSAGE[i] = DataManager.Instance.GET_STRING_DATA("iPLC8_EtoC_InterlockMessageConfirm", out bResult);

                                    msg.AddList(2);                                                                                 //L2  Interlock Set
                                    {
                                        msg.AddAscii(AppUtil.ToAscii(Unit8_aINTERLOCK_ID[i], 20));                                            //A20 Interlock Name  
                                        msg.AddAscii(AppUtil.ToAscii(Unit8_aMESSAGE[i], 120));                                                //A120 Interlock Message
                                    }
                                }
                            }
                        }
