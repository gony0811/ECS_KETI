...
{
    public class S6F11_CellProcessStart3 : SFMessage
    {
        /*S6F11(Cell Process Start), CEID:401*/
        public S6F11_CellProcessStart3(SECSDriver driver) 
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCELL_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInCellID3", out bResult);
            string sPPID = RMSManager.Instance.GetCurrentPPID();
            string sPRODUCT_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInProductID3", out bResult);
            string sSTEP_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInStepID3", out bResult);
            string sPROCESS_JOB = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInProcessJobID3", out bResult);
            string sPLAN_QTY = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_TrackInPlanQuantity3", out bResult).ToString();
            string sPROCESSED_QTY = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_TrackInProcessQuantity3", out bResult).ToString();
            string sREADER_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInReaderID3", out bResult);
            string sREAD_RESULT_CODE = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInRRC3", out bResult);
