...
{
    public class S6F11_ProcessJob_Loader1 : SFMessage
    {
        /*S6F11(Process Job), CEID:301, 302, 303, 304, 305, 306*/
        public S6F11_ProcessJob_Loader1(SECSDriver driver)
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCEID = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventCEID1", out bResult).ToString();
            ...
            string sPARENT_LOT = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_ProcessJobEvent1", out bResult);
            string sRFID = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_ProcessJobEventRFID1", out bResult);
            string sPORT_NO_1 = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventPortNo1", out bResult).ToString();
            string sPLAN_QTY = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventPlanQTY1", out bResult).ToString();
            string sPROCESSED_QTY = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventDQTY1", out bResult).ToString();
