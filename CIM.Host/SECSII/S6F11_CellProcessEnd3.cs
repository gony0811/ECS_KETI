...
{
    public class S6F11_CellProcessEnd3 : SFMessage
    {
        /*S6F11(Cell Process End), CEID:406*/
        public S6F11_CellProcessEnd3(SECSDriver driver) 
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            // RPTID "300"
            sCELLID = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutCellID3", out bResult);
            sPRODUCTID = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutProductID3", out bResult);
            sSTEPID = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutStepID3", out bResult);
            // RPTID "301"
            sPROCESS_JOB = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutProcessJobID3", out bResult);
            sPLANQTY = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TrackOutPlanQuantity3", out bResult).ToString();
            sPROCESSD_QTY = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TrackOutProcessQuantity3", out bResult).ToString();
            // RPTID "400"
            sREADER_ID = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutReaderID3", out bResult);
            sREADER_RESULTCODE = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutRRC3", out bResult);
            // RTPID "501"
            sOPERATOR_ID_1 = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutOperatorID3_1", out bResult);
            sOPERATOR_ID_2 = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutOperatorID3_1", out bResult);
            sOPERATOR_ID_3 = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutOperatorID3_1", out bResult);
            sJUDGE = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutJudge3", out bResult);
            sREASONCODE2 = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutReasonCode3", out bResult);
            sDESCRIPTION2 = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TrackOutDescription3", out bResult);
            // RPTID "201"
            if (nMAT_NO != 0)
            {
                aEQ_MAT_BAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_BatchID", out bResult);
                aEQ_MAT_BAT_NAME[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_BatchName", out bResult);
                aEQ_MAT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_ID", out bResult);
                aEQ_MAT_TYPE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_Type", out bResult);
                aEQ_MAT_ST[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_ST", out bResult);
                aEQ_MAT_PORT_ID[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_PortID", out bResult);
                aEQ_MAT_STATE[0] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_1_State", out bResult);
                aEQ_MAT_TOTAL_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_TotalQty", out bResult).ToString();
                aEQ_MAT_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_UseQty", out bResult).ToString();
                aEQ_MAT_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_AssemQty", out bResult).ToString();
                aEQ_MAT_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_NGQty", out bResult).ToString();
                aEQ_MAT_REMAINQTY_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_RemainQty", out bResult).ToString();
                aEQ_MAT_PRODUCT_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_ProductQty", out bResult).ToString();
                aEQ_MAT_PROCE_USE_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_ProcessUseQty", out bResult).ToString();
                aEQ_MAT_PROCE_ASSEM_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_ProcessAssemQty", out bResult).ToString();
                aEQ_MAT_PROC_NG_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_ProcessNGQty", out bResult).ToString();
                aEQ_MAT_SUPPLY_REQUEST_QTY[0] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_1_SupplyReqQty", out bResult).ToString();

                if (nMAT_NO >= 2)
                {
                    aEQ_MAT_BAT_ID[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_BatchID", out bResult);
                    aEQ_MAT_BAT_NAME[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_BatchName", out bResult);
                    aEQ_MAT_ID[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_ID", out bResult);
                    aEQ_MAT_TYPE[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_Type", out bResult);
                    aEQ_MAT_ST[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_ST", out bResult);
                    aEQ_MAT_PORT_ID[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_PortID", out bResult);
                    aEQ_MAT_STATE[1] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_2_State", out bResult);
                    aEQ_MAT_TOTAL_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_TotalQty", out bResult).ToString();
                    aEQ_MAT_USE_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_UseQty", out bResult).ToString();
                    aEQ_MAT_ASSEM_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_AssemQty", out bResult).ToString();
                    aEQ_MAT_NG_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_NGQty", out bResult).ToString();
                    aEQ_MAT_REMAINQTY_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_RemainQty", out bResult).ToString();
                    aEQ_MAT_PRODUCT_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_ProductQty", out bResult).ToString();
                    aEQ_MAT_PROCE_USE_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_ProcessUseQty", out bResult).ToString();
                    aEQ_MAT_PROCE_ASSEM_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_ProcessAssemQty", out bResult).ToString();
                    aEQ_MAT_PROC_NG_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_ProcessNGQty", out bResult).ToString();
                    aEQ_MAT_SUPPLY_REQUEST_QTY[1] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_2_SupplyReqQty", out bResult).ToString();
                }
                if (nMAT_NO >= 3)
                {
                    aEQ_MAT_BAT_ID[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_BatchID", out bResult);
                    aEQ_MAT_BAT_NAME[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_BatchName", out bResult);
                    aEQ_MAT_ID[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_ID", out bResult);
                    aEQ_MAT_TYPE[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_Type", out bResult);
                    aEQ_MAT_ST[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_ST", out bResult);
                    aEQ_MAT_PORT_ID[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_PortID", out bResult);
                    aEQ_MAT_STATE[2] = DataManager.Instance.GET_STRING_DATA("iPLC2_EtoC_TROUT3_3_State", out bResult);
                    aEQ_MAT_TOTAL_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_TotalQty", out bResult).ToString();
                    aEQ_MAT_USE_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_UseQty", out bResult).ToString();
                    aEQ_MAT_ASSEM_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_AssemQty", out bResult).ToString();
                    aEQ_MAT_NG_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_NGQty", out bResult).ToString();
                    aEQ_MAT_REMAINQTY_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_RemainQty", out bResult).ToString();
                    aEQ_MAT_PRODUCT_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_ProductQty", out bResult).ToString();
                    aEQ_MAT_PROCE_USE_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_ProcessUseQty", out bResult).ToString();
                    aEQ_MAT_PROCE_ASSEM_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_ProcessAssemQty", out bResult).ToString();
                    aEQ_MAT_PROC_NG_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_ProcessNGQty", out bResult).ToString();
                    aEQ_MAT_SUPPLY_REQUEST_QTY[2] = DataManager.Instance.GET_INT_DATA("iPLC2_EtoC_TROUT3_3_SupplyReqQty", out bResult).ToString();
                }
            }
            // RTPID "600"
            int nDV_NO = 0;

            Dictionary<string, string> dvNameValueList = DVManager.Instance.GetDVNameValueList("PLC2", "PORT3");
