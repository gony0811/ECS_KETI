...
{
    public class S6F11_ProcessJob_Loader2 : SFMessage
    {
        /*S6F11(Process Job), CEID:301, 302, 303, 304, 305, 306*/
        public S6F11_ProcessJob_Loader2(SECSDriver driver)
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCEID = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventCEID2", out bResult).ToString();
            ...
            string sPORT_NO1 = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_PortNo2", out bResult);
            string sPORT_AVAILABLE_STATE1 = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_PortAvailstate2", out bResult);
            string sPORT_ACCESS_MODE1 = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_PortAccessMode2", out bResult);
            string sPORT_TRANSFER_STATE1 = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_PortTransferState2", out bResult);
            string sPORT_PROCESSING_STATE1 = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_PortProcessingState2", out bResult);

            string sPARENT_LOT = DataManager.Instance.GET_STRING_DATA("iPLC7_EtoC_ProcessJobEvent2", out bResult);
            string sRFID = "";  // MAP에 영역 없음
            string sPORT_NO_1 = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventPortNo2", out bResult).ToString();
            string sPLAN_QTY = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventPlanQTY2", out bResult).ToString();
            string sPROCESSED_QTY = DataManager.Instance.GET_INT_DATA("iPLC7_EtoC_ProcessJobEventDQTY2", out bResult).ToString();
