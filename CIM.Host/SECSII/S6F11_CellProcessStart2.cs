...
{
    public class S6F11_CellProcessStart2 : SFMessage
    {
        /*S6F11(Cell Process Start), CEID:401*/
        public S6F11_CellProcessStart2(SECSDriver driver) 
            : base(driver)
        {
        ...
        public override void DoWork(string driverName, object obj)
        {
            ...
            string sCELL_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInCellID2", out bResult);
            string sPPID = RMSManager.Instance.GetCurrentPPID();
            string sPRODUCT_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInProductID2", out bResult);
            string sSTEP_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInStepID2", out bResult);
            string sPROCESS_JOB = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInProcessJobID2", out bResult);
            string sPLAN_QTY = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_TrackInPlanQuantity2", out bResult).ToString();
            string sPROCESSED_QTY = DataManager.Instance.GET_INT_DATA("iPLC1_EtoC_TrackInProcessQuantity2", out bResult).ToString();
            string sREADER_ID = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInReaderID2", out bResult);
            string sREAD_RESULT_CODE = DataManager.Instance.GET_STRING_DATA("iPLC1_EtoC_TrackInRRC2", out bResult);
