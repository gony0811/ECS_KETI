...
{
    class S6F11_PortStatusChange_Unlooader_CEID254_255 : SFMessage
    {
        /*S6F11(PortStatusChange_Unlooader), CEID:254, 255*/
        private string _ceid;
        private string _portName;
        private string _portID;

        public S6F11_PortStatusChange_Unlooader_CEID254_255(SECSDriverBase driver, string CEID, string PortID, string PortName)
            : base(driver)
        {
